...
class Home extends React.Component {
    constructor() {
        ...
        this.renderItem1 = ({ item }) => {
            return (React.createElement(TouchableOpacity, { style: { width: width / 4, alignItems: 'center', marginTop: 10 }, onPress: () => {
        ...
        this.renderItem2 = ({ item }) => {
            return (React.createElement(TouchableOpacity, { style: { marginStart: 10, marginBottom: 10 } },
                React.createElement(Image, { source: item.image, style: { width: width - 20, height: height / 5 } })));
        };
    }
    render() {
        const data = [
        ...
        return (React.createElement(View, { style: { backgroundColor: '#FFFFFF' } },
            React.createElement(ScrollView, null,
                React.createElement(View, { style: { paddingBottom: 10 } },
                    ...
                    React.createElement(Text, { style: { marginTop: height / 6 + 15, color: '#85563a', fontWeight: 'bold', fontSize: 15, marginStart: 10 } }, "\u0110\u1EB6T V\u00C9 T\u00C0U, XE, M\u00C1Y BAY"),
