...
export default class Promotion extends Component {
    ...
    render() {
        const data1 = [
            { id: '1', image: sale, content: "Giảm giá 50% khi mua 4 vé trở lên" },
            { id: '2', image: sale, content: "Giảm giá 20% từ 22-4 đến 2-5-2019" },
            { id: '3', image: sale, content: "Miễn phí cho người thứ 5" },
            { id: '4', image: sale, content: "Miễn phí cho trẻ dưới 6 tuổi" },
        ]
